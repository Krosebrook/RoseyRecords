...
import { Music, LayoutDashboard, Mic2, LogOut, User, Compass, Headphones, Activity, ListMusic, Heart, Settings, ShoppingBag, SlidersHorizontal, Bell, Video } from "lucide-react";
