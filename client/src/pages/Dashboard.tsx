      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Manage your generated songs and lyrics.</p>
          </div>
          <Link href="/generate" className="px-6 py-3 rounded-xl bg-primary hover:bg-primary/90 text-white font-semibold shadow-lg hover:shadow-xl transition-all flex items-center gap-2 w-full md:w-auto justify-center">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-card/30 rounded-3xl border border-dashed border-border text-center">
            ...
            <Link href="/generate" className="text-primary hover:underline font-medium">
