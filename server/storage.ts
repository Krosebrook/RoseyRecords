...
export class DatabaseStorage implements IStorage {
  ...
  async getPlaylistWithSongs(id: number): Promise<(Playlist & { songs: Song[] }) | undefined> {
    ...
    // Optimized: Use innerJoin to fetch songs directly, reducing DB queries from 3 to 2
    // Also ensures proper ordering based on when songs were added to the playlist
